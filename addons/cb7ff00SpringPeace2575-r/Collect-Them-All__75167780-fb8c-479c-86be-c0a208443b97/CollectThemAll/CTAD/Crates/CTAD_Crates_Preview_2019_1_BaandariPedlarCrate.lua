CollectThemAllData_Crates_Preview_2019_1_BaandariPedlarCrate = {
    name = "Baandari Pedlar (2019 - Previews)",
    source = "Crates",
    collection = {
        [COLLECTIBLE_CATEGORY_TYPE_MOUNT] = {},
        [COLLECTIBLE_CATEGORY_TYPE_VANITY_PET] = {
            { name = "Pedlar Pack Pony", q = 3 },
            { name = "Pedlar Pack Senche-Lion Cub", q = 3 },
            { name = "Pedlar Pack Spider", q = 3 },
            { name = "Pedlar Pack Wolf Cub", q = 3 },
        },
