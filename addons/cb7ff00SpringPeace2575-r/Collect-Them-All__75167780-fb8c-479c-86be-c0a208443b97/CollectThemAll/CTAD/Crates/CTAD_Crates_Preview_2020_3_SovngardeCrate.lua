CollectThemAllData_Crates_Preview_2020_3_SovngardeCrate = {
    name = "Sovngarde (2020 - Previews)",
    source = "Crates",
    collection = {
        [COLLECTIBLE_CATEGORY_TYPE_MOUNT] = {},
        [COLLECTIBLE_CATEGORY_TYPE_VANITY_PET] = {
            { name = "Sovngarde Bear Cub", q = 3 },
            { name = "Sovngarde Pony Guar", q = 3 },
            { name = "Sovngarde Pony", q = 3 },
            { name = "Sovngarde Sabre Cat Cub", q = 3 },
            { name = "Sovngarde Wolf Pup", q = 3 },
        },
