...
--[[Calculates time of next daily quest reset in UTC.
	...
	Reset is at 10am UTC for NA and 3am UTC for EU. If your computer clock is off, this will be off.
...
function Utils:stripPrefixes(string, prefixes)
	for _, prefix in ipairs(prefixes) do
		if string:sub(1, #prefix) == prefix then
			return zo_strformat("<<C:1>>", (string:sub(#prefix + 1, #string)))
		end
	end
