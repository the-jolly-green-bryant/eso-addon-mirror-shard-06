...
function mmUtils:GetGuildSales(guildName, displayName, dateRange)
  local seller = MMSeller.sellers and MMSeller.sellers[guildName] and MMSeller.sellers[guildName][displayName]
  return (seller and seller.sales and seller.sales[dateRange]) or 0
end

function mmUtils:GetSalesCount(guildName, displayName, dateRange)
  local seller = MMSeller.sellers and MMSeller.sellers[guildName] and MMSeller.sellers[guildName][displayName]
  return (seller and seller.count and seller.count[dateRange]) or 0
end

function mmUtils:GetSalesTaxes(guildName, displayName, dateRange)
  local seller = MMSeller.sellers and MMSeller.sellers[guildName] and MMSeller.sellers[guildName][displayName]
  return (seller and seller.tax and seller.tax[dateRange]) or 0
end

function mmUtils:GetGuildPurchases(guildName, displayName, dateRange)
  local buyer = MMBuyer.buyers and MMBuyer.buyers[guildName] and MMBuyer.buyers[guildName][displayName]
  return (buyer and buyer.purchases and buyer.purchases[dateRange]) or 0
end
