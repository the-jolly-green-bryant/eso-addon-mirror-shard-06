...
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_HOURS", "Godziny")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_DAYS", "Dni")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_WEEKS", "Tygodnie")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_GUILD_WEEKS", "Pełne tygodnie gildyjne")
