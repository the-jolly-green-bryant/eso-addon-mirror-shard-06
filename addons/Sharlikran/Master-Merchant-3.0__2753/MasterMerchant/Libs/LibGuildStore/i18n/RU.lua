...
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_HOURS", "Часы")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_DAYS", "Сутки")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_WEEKS", "Календарные недели")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_GUILD_WEEKS", "Торговые недели")
