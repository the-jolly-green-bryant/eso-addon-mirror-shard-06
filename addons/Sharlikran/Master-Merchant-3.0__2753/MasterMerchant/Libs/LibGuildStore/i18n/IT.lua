...
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_HOURS", "Ore")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_DAYS", "Giorni")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_WEEKS", "Settimane")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_GUILD_WEEKS", "Settimane complete della Gilda")
