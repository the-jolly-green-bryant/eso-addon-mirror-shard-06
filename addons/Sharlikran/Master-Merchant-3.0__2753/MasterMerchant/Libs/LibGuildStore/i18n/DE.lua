...
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_HOURS", "Stunden")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_DAYS", "Tage")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_WEEKS", "Wochen")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_GUILD_WEEKS", "Volle Gilden Wochen")
