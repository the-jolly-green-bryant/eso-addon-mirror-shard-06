...
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_HOURS", "Hours")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_DAYS", "Days")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_WEEKS", "Weeks")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_GUILD_WEEKS", "Full Guild Weeks")
