...
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_HOURS", "Heures")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_DAYS", "Jours")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_WEEKS", "Semaine")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_GUILD_WEEKS", "Semaines de guilde complètes")
