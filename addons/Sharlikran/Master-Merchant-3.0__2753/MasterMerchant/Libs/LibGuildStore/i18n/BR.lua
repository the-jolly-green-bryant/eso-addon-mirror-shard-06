...
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_HOURS", "Horas")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_DAYS", "Dias")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_WEEKS", "Semanas")
ZO_CreateStringId("GS_CUSTOM_TIMEFRAME_GUILD_WEEKS", "Semanas Completas das Guildas")
