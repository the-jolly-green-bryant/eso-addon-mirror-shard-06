...
local function SetupDefaults()
  ...
  local systemDefault = {
    ...
    customTimeframeType = LGS_TIMEFRAME_DAYS,
    customTimeframe = 90,
    customFilterDateRange = 90,
    customTimeframeText = "",
  }
  systemDefault.customTimeframeText = tostring(systemDefault.customTimeframe) .. ' ' .. GetString(GS_CUSTOM_TIMEFRAME_DAYS)
  ...
  LGSTime:SetCustomTimeframe(savedVars.customTimeframeType,savedVars.customTimeframe,savedVars.customFilterDateRange)
  LGSTime:Initialize()
  ...
  MMGuild:InitializeGuildMembers()
...
local function SetupData()
  ...
  -- LEQ:addTask(function() StartScriptProfiler() end, 'StartScriptProfiler')
  LEQ:addTask(function() internal:InitSalesHistory() end, 'InitSalesHistory')
  -- LEQ:addTask(function() StopScriptProfiler() end, 'StopScriptProfiler')
