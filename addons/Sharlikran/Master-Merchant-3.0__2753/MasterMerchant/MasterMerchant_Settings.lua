...
function MasterMerchant:SetupOptionsData()
  ...
  optionsData[#optionsData + 1] = {
    ...
    min = 15,
    max = 365,
    getFunc = function() return LGSTime:GetCustomFilterDateRange() end,
    setFunc = function(value)
      LibGuildStore_SavedVariables.customFilterDateRange = value
    end,
    default = LGSTime.defaultCustomFilterDateRange,
  }
  -- Sales Options -----------------------------------
  optionsData[#optionsData + 1] = {
    type = "header",
  ...
  optionsData[#optionsData + 1] = {
    ...
    controls = {
      ...
      [9] = {
        ...
        min = 1,
        max = 24 * 31,
        getFunc = function() return LGSTime:GetCustomTimeframe() end,
        setFunc = function(value)
          local customTimeframe = value
          LGSTime:SetCustomTimeframe(LGSTime.customTimeframeType, customTimeframe, LGSTime.customFilterDateRange)
          LibGuildStore_SavedVariables.customTimeframe = LGSTime.customTimeframe
          LibGuildStore_SavedVariables.customTimeframeText = LGSTime.customTimeframeText
          MasterMerchant:BuildRosterTimeDropdown()
          MasterMerchant:BuildGuidTimeDropdown()
        end,
        default = LGSTime.defaultCustomTimeframe,
      ...
      [10] = {
        ...
        choicesValues = LGSTime:GetCustomTimeframeChoiceValues(),
        choices = LGSTime:GetCustomTimeframeChoices(),
        getFunc = function() return LGSTime:GetCustomTimeframeType() end,
        setFunc = function(value)
          local customTimeframeType = value
          LGSTime:SetCustomTimeframe(customTimeframeType, LGSTime.customTimeframe, LGSTime.customFilterDateRange)
          LibGuildStore_SavedVariables.customTimeframeType = LGSTime.customTimeframeType
          LibGuildStore_SavedVariables.customTimeframeText = LGSTime.customTimeframeText
          MasterMerchant:BuildRosterTimeDropdown()
          MasterMerchant:BuildGuidTimeDropdown()
        end,
        default = LGSTime.defaultCustomTimeframeType,
        warning = GetString(MM_CUSTOM_TIMEFRAME_WARN),
        requiresReload = true,
      },
    },
