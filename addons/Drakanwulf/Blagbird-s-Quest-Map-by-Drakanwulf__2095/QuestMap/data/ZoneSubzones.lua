...
This module creates, initializes, and updates the Quest Map quest by subzone reference table.  It provide the (x,y) locations of 
every quest available to a character whenever the character enters or accesses a game subzone (ie. dungeon).  Note that you 
should not be able to see below ground quest pins when you are on the surface.  It's confusing... :)
