...
ShissuLocalization["ShissuDonateFee"] = {
  ...
  SET_AUTODIALOG =    "Automatic opening",
  SET_AUTODIALOG_TT = "Automatically open the SDF window when opening guild recordings. Alternatively /sdf must be entered in the chat if required.",      
